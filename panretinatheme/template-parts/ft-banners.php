<!-- Start Banner
============================================= -->
<div id="js-banner-swiper" class="c-banner-swiper">
    ...
    <div class="swiper">
            ...
            <div class="swiper-slide">
                <a <?= $link . $targ; ?> title="<?= get_the_title(); ?>">
                    <picture>
                        ...
                        <img src="<?= $mobile['url']; ?>" alt="<?= get_the_title(); ?>" class="h-auto max-w-full w-full">
                    </picture>
                </a>
            </div>
        ...
        <div class="swiper-pagination swiper-pagination__secondary"></div>
...
<script>
    jQuery(document).ready(function($) {
        // SWIPER
        const banner = new Swiper('#js-banner-swiper .swiper', {
            // Optional parameters
            loop: true,
