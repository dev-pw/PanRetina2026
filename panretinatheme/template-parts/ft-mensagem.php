<section class="pb-20">
    <div class="2xl:max-w-330 2xl:mx-auto relative">
        ...
        <div class="grid grid-cols-12 relative 2xl:rounded-xl overflow-hidden">
            ...
            <div class="col-span-12 lg:col-span-8 bg-gray-50 py-20 relative">
                <div class="px-10 lg:ps-30 2xl:ps-25 text-white order-1">
                    <h2 class="text-primary mb-6 font-black"> <?= is_language('Message from the President', 'Mensaje del Presidente', 'Mensagem do Presidente'); ?> </h2>
