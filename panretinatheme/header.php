         ...
         <div class="flex justify-end items-center">
            ...
            <div class="md:w-[33%] text-end">
               ...
               <div class="inline-flex gap-3 items-center">
                  ...
                  <button type="button" id="toggle" class="size-12 flex gap-[6px] flex-col justify-center items-end bg-gray-100 md:bg-white hover:bg-secondary rounded-lg p-2 outline-hidden transition-all duration-300 group/toggle" aria-haspopup="dialog" aria-expanded="false" aria-controls="drawer-navigation" data-hs-overlay="#drawer-navigation" aria-label="drawer-navigation">
